...
export function useInspection() {
  ...
  // 获取巡检派单列表
  function getOrderInspectionList(index: Ref<number> | number, pageIndex = 1) {
    const p: any = {
      index: pageIndex,
    ...
    return new Promise((resolve, reject) => {
      useGetRequest<IInspectionRes>(
        "order_inspection/getOrderPageList",
        p
      ).then((res) => {
        resolve(res.data);
      });
  ...
  // 查看指定巡检记录
  function getOrderInspection(id: Ref<string> | string) {
    const p = {
      id,
    };
    return new Promise((resolve, reject) => {
  ...
  function getMaintenanceLogList(id: Ref<string> | string) {
    ...
    return new Promise((resolve, reject) => {
      useGetRequest<IInspectionLogRes>(
        "order_inspection/getMaintenanceLogList",
        p
      ).then((res) => {
        resolve(res.data);
      });
  ...
  function getColleagueList(id: Ref<string> | string) {
    return new Promise((resolve, reject) => {
      useGetRequest<IColleagueListRes>("order_inspection/getColleagueList", {
        id,
      }).then((res) => {
        resolve(res.data);
      });
  ...
  function optionItem(data: any) {
    return new Promise((resolve, reject) => {
      usePostRequest<any>("order_inspection/optionItem", data).then((res) => {
        resolve(res.data);
      });
    });
  }
  // 二维码解码
  function scanInspectionQrcode(data: { erData: string; orderId: string }) {
    return new Promise((resolve, reject) => {
      usePostRequest("order_inspection/scanQrcode", data).then((res) => {
        resolve(res.data);
      });
    });
  }
  ...
  function applicationAccept(data: any) {
    return new Promise((resolve, reject) => {
      usePostRequest<any>("order_inspection/applicationAccept", data).then(
        (res) => {
          resolve(res.data);
        }
      );
  ...
  function notCompletedSave(data: any) {
    return new Promise((resolve, reject) => {
      usePostRequest<any>("order_inspection/notCompletedSave", data).then(
        (res) => {
          resolve(res.data);
        }
      );
  ...
  function acceptanceOrder(data: any) {
    return new Promise((resolve, reject) => {
      usePostRequest<any>("order_inspection/acceptanceOrder", data).then(
        (res) => {
          resolve(res.data);
        }
      );
  ...
  function grabbingMaintain(data: { orderId: string }) {
    return new Promise((resolve, reject) => {
      usePostRequest<any>("order_inspection/grabbingMaintain", data).then(
        (res) => {
          resolve(res.data);
        }
      );
...
export interface IInspectionRes {
  id: string;
